...
public class GrassOverhaul implements ModInitializer {
	...
	public static final ItemGroup tabsod = FabricItemGroupBuilder.create(
		...
		.appendItems(stacks -> {
			...
			stacks.add(new ItemStack(GOBlocks.DIRT_SOD_SLAB));
			stacks.add(new ItemStack(GOBlocks.DIRT_SOD_STAIRS));
			stacks.add(new ItemStack(GOBlocks.DIRT_SOD_PATCH));
			stacks.add(new ItemStack(GOBlocks.GRASS_SOD_BLOCK));
			stacks.add(new ItemStack(GOBlocks.GRASS_SOD_SLAB));
			stacks.add(new ItemStack(GOBlocks.GRASS_SOD_STAIRS));
			stacks.add(new ItemStack(GOBlocks.GRASS_SOD_PATCH));
			stacks.add(new ItemStack(GOBlocks.PATH_SOD_BLOCK));
			stacks.add(new ItemStack(GOBlocks.PATH_SOD_SLAB));
			stacks.add(new ItemStack(GOBlocks.PATH_SOD_STAIRS));
			stacks.add(new ItemStack(GOBlocks.PATH_SOD_PATCH));
			stacks.add(new ItemStack(GOBlocks.MYCELIUM_SOD_BLOCK));
			stacks.add(new ItemStack(GOBlocks.MYCELIUM_SOD_SLAB));
			stacks.add(new ItemStack(GOBlocks.MYCELIUM_SOD_STAIRS));
			stacks.add(new ItemStack(GOBlocks.MYCELIUM_SOD_PATCH));
			stacks.add(new ItemStack(GOBlocks.PODZOL_SOD_BLOCK));
			stacks.add(new ItemStack(GOBlocks.PODZOL_SOD_SLAB));
			stacks.add(new ItemStack(GOBlocks.PODZOL_SOD_STAIRS));
			stacks.add(new ItemStack(GOBlocks.PODZOL_SOD_PATCH));
			stacks.add(new ItemStack(GOBlocks.CRIMSON_NYLIUM_SOD_BLOCK));
			stacks.add(new ItemStack(GOBlocks.CRIMSON_NYLIUM_SOD_SLAB));
			stacks.add(new ItemStack(GOBlocks.CRIMSON_NYLIUM_SOD_STAIRS));
			stacks.add(new ItemStack(GOBlocks.CRIMSON_NYLIUM_SOD_PATCH));
			stacks.add(new ItemStack(GOBlocks.WARPED_NYLIUM_SOD_BLOCK));
			stacks.add(new ItemStack(GOBlocks.WARPED_NYLIUM_SOD_SLAB));
			stacks.add(new ItemStack(GOBlocks.WARPED_NYLIUM_SOD_STAIRS));
