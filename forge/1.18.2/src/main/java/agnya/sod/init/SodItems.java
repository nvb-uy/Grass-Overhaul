...
public class SodItems {
	...
	public static final RegistryObject<Item> DIRT_SOD_STAIRS = block(SodBlocks.DIRT_SOD_STAIRS, Sod.TAB_SOD);
	...
	public static final RegistryObject<Item> GRASS_SOD_STAIRS = block(SodBlocks.GRASS_SOD_STAIRS, Sod.TAB_SOD);
	...
	public static final RegistryObject<Item> PATH_SOD_STAIRS = block(SodBlocks.PATH_SOD_STAIRS, Sod.TAB_SOD);
	...
	public static final RegistryObject<Item> MYCELIUM_SOD_STAIRS = block(SodBlocks.MYCELIUM_SOD_STAIRS, Sod.TAB_SOD);
	...
	public static final RegistryObject<Item> PODZOL_SOD_STAIRS = block(SodBlocks.PODZOL_SOD_STAIRS, Sod.TAB_SOD);
	...
	public static final RegistryObject<Item> CRIMSON_NYLIUM_SOD_STAIRS = block(SodBlocks.CRIMSON_NYLIUM_SOD_STAIRS, Sod.TAB_SOD);
	...
	public static final RegistryObject<Item> WARPED_NYLIUM_SOD_STAIRS = block(SodBlocks.WARPED_NYLIUM_SOD_STAIRS, Sod.TAB_SOD);
